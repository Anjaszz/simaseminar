...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    foreach ($vendor as $r) { ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?= $r->active === '1' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' ?>">
    ...
    <a href="<?= site_url("master/vendor/update/{$r->id_vendor}") ?>" 
    ...
    <button data-url="<?= site_url('master/vendor/delete/' . $r->id_vendor) ?>" 
            class="remove-vendor inline-flex items-center px-3 py-1 bg-red-100 text-red-700 hover:bg-red-200 rounded-lg transition-colors duration-200">
