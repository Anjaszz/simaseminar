...
<script>
    $("body").on("click", ".remove-data", function(e) {
        e.preventDefault();
        var targetUrl = $(this).attr("href"); // Ambil URL dari atribut href
        var id = $(this).attr("data-id"); // Ambil ID data yang akan dihapus
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: targetUrl, // URL untuk request delete
                    type: 'POST', // Gunakan metode POST (pastikan server menangani dengan POST)
                    data: { id: id }, // Kirim ID data untuk dihapus
