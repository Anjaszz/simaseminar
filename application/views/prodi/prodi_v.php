           ...
           <table class="min-w-full divide-y divide-gray-200">
               <thead>
                   <tr class="bg-gray-50">
                       ...
                       <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Jurusan</th>
                       <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Jurusan</th>
               ...
               <tbody class="bg-white divide-y divide-gray-200">
                   <?php $no = 1; foreach ($prodi as $r) { ?>
                       <tr class="hover:bg-gray-50">
                           ...
                           <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center"><?= $r->nama_prodi ?></td>
                           ...
                           <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                               <a href="<?= site_url("prodi/detail/{$r->id_prodi}") ?>"
